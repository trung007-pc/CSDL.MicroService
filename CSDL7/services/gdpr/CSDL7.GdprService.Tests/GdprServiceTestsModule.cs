...
namespace CSDL7.GdprService.Tests;

/* This project has a dotnet project reference to the CSDL7.GdprService project,
 * but it does not have a module dependency to the CSDL7GdprServiceModule module class.
 * Because, CSDL7GdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7GdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7GdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7GdprServiceModule))]
