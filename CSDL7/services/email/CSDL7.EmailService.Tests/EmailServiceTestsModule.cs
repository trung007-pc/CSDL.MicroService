...
namespace CSDL7.EmailService.Tests;

/* This project has a dotnet project reference to the CSDL7.EmailService project,
 * but it does not have a module dependency to the CSDL7EmailServiceModule module class.
 * Because, CSDL7EmailServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7EmailServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7EmailServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7EmailServiceModule))]
public class EmailServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<EmailServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // EmailServiceDbContext ()
        new EmailServiceDbContext(
            new DbContextOptionsBuilder<EmailServiceDbContext>().UseSqlite(connection).Options
