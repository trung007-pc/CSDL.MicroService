...
using CSDL7.AuditLoggingService.HealthChecks;
using Prometheus;
...
public class CSDL7AuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<CSDL7AuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<CSDL7AuditLoggingServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(CSDL7AuditLoggingServiceModule).Assembly, opts =>
                {
