...
namespace CSDL7.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the CSDL7.AuditLoggingService project,
 * but it does not have a module dependency to the CSDL7AuditLoggingServiceModule module class.
 * Because, CSDL7AuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7AuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7AuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7AuditLoggingServiceModule))]
