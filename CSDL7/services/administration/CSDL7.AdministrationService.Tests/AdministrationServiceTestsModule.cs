...
namespace CSDL7.AdministrationService.Tests;

/* This project has a dotnet project reference to the CSDL7.AdministrationService project,
 * but it does not have a module dependency to the CSDL7AdministrationServiceModule module class.
 * Because, CSDL7AdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7AdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7AdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7AdministrationServiceModule))]
