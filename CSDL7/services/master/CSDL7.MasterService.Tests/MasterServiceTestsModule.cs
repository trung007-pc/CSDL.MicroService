...
namespace CSDL7.MasterService.Tests;

/* This project has a dotnet project reference to the CSDL7.MasterService project,
 * but it does not have a module dependency to the CSDL7MasterServiceModule module class.
 * Because, CSDL7MasterServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7MasterServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7MasterServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7MasterServiceModule))]
public class MasterServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<MasterServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // MasterServiceDbContext ()
        new MasterServiceDbContext(
            new DbContextOptionsBuilder<MasterServiceDbContext>().UseSqlite(connection).Options
