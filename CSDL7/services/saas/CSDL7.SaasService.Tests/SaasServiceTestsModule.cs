...
namespace CSDL7.SaasService.Tests;

/* This project has a dotnet project reference to the CSDL7.SaasService project,
 * but it does not have a module dependency to the CSDL7SaasServiceModule module class.
 * Because, CSDL7SaasServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7SaasServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7SaasServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7SaasServiceModule))]
