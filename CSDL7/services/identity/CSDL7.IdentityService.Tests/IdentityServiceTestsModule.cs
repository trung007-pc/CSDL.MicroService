...
using CSDL7.IdentityService.Data;
using Volo.Abp;
...
namespace CSDL7.IdentityService.Tests;

/* This project has a dotnet project reference to the CSDL7.IdentityService project,
 * but it does not have a module dependency to the CSDL7IdentityServiceModule module class.
 * Because, CSDL7IdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7IdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7IdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7IdentityServiceModule))]
