...
using CSDL7.IdentityService.HealthChecks;
...
public class CSDL7IdentityServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<CSDL7IdentityServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(CSDL7IdentityServiceModule).Assembly, opts =>
                {
