...
/* This project has a dotnet project reference to the CSDL7.LanguageService project,
 * but it does not have a module dependency to the CSDL7LanguageServiceModule module class.
 * Because, CSDL7LanguageServiceModule has configurations proper for development and production
 ...
 *
 * For example, CSDL7LanguageServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change CSDL7LanguageServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(CSDL7LanguageServiceModule))]
